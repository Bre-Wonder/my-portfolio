...
export const projects = [
  {
    ...
    screenshot: process.env.PUBLIC_URL + '/images/Pokedex.png', // Add your screenshot path here
  ...
  },
  {
    ...
    image: '🌤️',
    screenshot: process.env.PUBLIC_URL + '/images/myFlix-React.png',
  ...
  },
  {
    ...
    image: '🔧',
    screenshot: process.env.PUBLIC_URL + '/images/myFlix-Angular.png',
